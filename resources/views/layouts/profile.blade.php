...
@if ($user->role == 'admin')
    @section('section', 'Profil Admin')
@elseif ($user->role == 'pelanggan')
    @section('section', 'Profil Pelanggan')
@endif
    ...
    <div class="col-xl-4">
        ...
        <div class="card">
            <div class="card-body profile-card pt-4 d-flex flex-column align-items-center">
                ...
                <h2 class="text-primary mb-0"><b>{{ $user->nama }}</b></h2>
                <h5 class="mb-0">{{ $user->username }}</h5>
                @if ($user->role == 'pelanggan')
                    <div class="social-links mt-2">
                        <span class="whatsapp text-success"><i class="bi bi-whatsapp"></i> {{ $user->no_hp }}</span>
                    </div>
                @endif
        ...
        <div class="card">
            <div class="card-body pt-3">
                ...
                <ul class="nav nav-tabs nav-tabs-bordered">
                    ...
                    <li class="nav-item">
                        <button class="nav-link" data-bs-toggle="tab" data-bs-target="#profile-change-username">Change
                            Username</button>
                    </li>
                ...
                <div class="tab-content pt-2">
                    ...
                    <div class="tab-pane fade pt-3" id="profile-change-username">
                        ...
                        <form>
                            ...
                            <div class="row mb-3">
                                <label for="currentPassword" class="col-md-4 col-lg-3 col-form-label">Username
                                    Baru</label>
                                <div class="col-md-8 col-lg-9">
                                    <input name="password" type="password" class="form-control" id="currentPassword">
                                </div>
